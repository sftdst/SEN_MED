...
const MENU_ITEMS = [
  ...
  { key: 'formulaire',  label: 'Formulaire document', icon: '📝' },
  { key: 'salle',       label: "Salle d'hospitalisation", icon: '🛏️' },
...
function AccueilTab() {
  const cards = [
    ...
    { label: 'Salles hospitalisation', val: '8', icon: '🛏️', color: colors.warning, bg: colors.warningBg },
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {['pays','ville','parametres','formulaire','salle','environnement'].includes(activeTab) && (
