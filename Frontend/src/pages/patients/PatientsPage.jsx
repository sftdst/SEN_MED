    ...
    <div>
      <PageHeader
        ...
        actions={
          <div style={{ display: 'flex', gap: spacing.sm }}>
            <Button onClick={() => { setModalRapide(true); setFormRapide(EMPTY_RAPIDE); setFormErrors({}) }} icon="⚡" variant="warning">
              Création rapide
            </Button>
            <Button onClick={() => { setModalComplet(true); setFormComplet(EMPTY_COMPLET); setFormErrors({}) }} icon="➕">
              Fiche complète
            </Button>
          </div>
        }
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', flex: 1, minWidth: 200 }}>
          ...
          <input
            placeholder="Rechercher (nom, code, téléphone, NSS)..."
            value={search}
